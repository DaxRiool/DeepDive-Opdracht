...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li>
        <a class="nav-link" href="insert-steps.php?id=<?php echo $id ?>">add steps</a>
    </li>
    </ul>
...
$stmt = $pdo->query("SELECT * FROM shittest1 WHERE mashineid = $id ORDER BY id ASC");
    while ($row = $stmt->fetch()) {
        echo "<h4> step ", $row['stepid'], " ", $row['steps'] . "\n" . '</h4>'; ?><?php
    }
